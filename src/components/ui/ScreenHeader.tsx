  ...
  return (
    <header className="flex items-center justify-between py-1">
      <div className="flex items-center gap-2">
        {back && (
          <button onClick={() => router.back()} aria-label="Back" className="text-sub">
      ...
      {action && (
        <button onClick={action.onClick} className="text-[13px] text-sub">
          {action.label}
        </button>
      )}
      {close && (
        <button onClick={() => router.back()} aria-label="Close" className="text-sub">
