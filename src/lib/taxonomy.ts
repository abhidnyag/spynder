...
export const SUBGENRES: { label: string; seed: string; group: string }[] = [
  ...
  { label: "Math Rock", seed: "math rock", group: "Rock" },
  { label: "Stoner Rock", seed: "stoner rock", group: "Rock" },
  { label: "Glam Rock", seed: "glam rock", group: "Rock" },
  { label: "Krautrock", seed: "krautrock", group: "Rock" },
  { label: "Yacht Rock", seed: "yacht rock", group: "Rock" },
  { label: "Arena Rock", seed: "arena rock", group: "Rock" },
  { label: "Southern Rock", seed: "southern rock", group: "Rock" },
  { label: "Heartland Rock", seed: "heartland rock", group: "Rock" },
  { label: "Gothic Rock", seed: "gothic rock", group: "Rock" },
  { label: "Noise Rock", seed: "noise rock", group: "Rock" },
  { label: "Space Rock", seed: "space rock", group: "Rock" },
  { label: "Rockabilly", seed: "rockabilly", group: "Rock" },
  // Metal
  ...
  { label: "Progressive Metal", seed: "progressive metal", group: "Metal" },
  { label: "Symphonic Metal", seed: "symphonic metal", group: "Metal" },
  { label: "Folk Metal", seed: "folk metal", group: "Metal" },
  { label: "Groove Metal", seed: "groove metal", group: "Metal" },
  { label: "Deathcore", seed: "deathcore", group: "Metal" },
  { label: "Djent", seed: "djent", group: "Metal" },
  { label: "Industrial Metal", seed: "industrial metal", group: "Metal" },
  // Pop
  ...
  { label: "Baroque Pop", seed: "baroque pop", group: "Pop" },
  { label: "Bubblegum Pop", seed: "bubblegum pop", group: "Pop" },
  { label: "Teen Pop", seed: "teen pop", group: "Pop" },
  { label: "City Pop", seed: "city pop", group: "Pop" },
  { label: "Modern Pop", seed: "modern pop", group: "Pop" },
  { label: "Acoustic Pop", seed: "acoustic pop", group: "Pop" },
  { label: "Sophisti-pop", seed: "sophisti-pop", group: "Pop" },
  { label: "Chamber Pop", seed: "chamber pop", group: "Pop" },
  { label: "Europop", seed: "europop", group: "Pop" },
  { label: "Sunshine Pop", seed: "sunshine pop", group: "Pop" },
  // Indie
  ...
  { label: "Slowcore", seed: "slowcore", group: "Indie" },
  { label: "Post-Punk Revival", seed: "post-punk revival", group: "Indie" },
  // Hip-Hop
  ...
  { label: "Old School Hip-Hop", seed: "old school hip hop", group: "Hip-Hop" },
  { label: "West Coast Hip-Hop", seed: "west coast rap", group: "Hip-Hop" },
  { label: "East Coast Hip-Hop", seed: "east coast hip hop", group: "Hip-Hop" },
  { label: "Alternative Hip-Hop", seed: "alternative hip hop", group: "Hip-Hop" },
  { label: "Crunk", seed: "crunk", group: "Hip-Hop" },
  { label: "Phonk", seed: "phonk", group: "Hip-Hop" },
  { label: "Grime", seed: "grime", group: "Hip-Hop" },
  // R&B
  ...
  { label: "Garage Punk", seed: "garage punk", group: "Punk" },
  { label: "Skate Punk", seed: "skate punk", group: "Punk" },
  { label: "Riot Grrrl", seed: "riot grrrl", group: "Punk" },
  { label: "Crust Punk", seed: "crust punk", group: "Punk" },
  { label: "Oi!", seed: "oi", group: "Punk" },
  // Electronic
  ...
  { label: "Tech House", seed: "tech house", group: "Electronic" },
  { label: "Progressive House", seed: "progressive house", group: "Electronic" },
  { label: "Electro", seed: "electro", group: "Electronic" },
  { label: "IDM", seed: "idm", group: "Electronic" },
  { label: "Breakbeat", seed: "breakbeat", group: "Electronic" },
  { label: "Trip-Hop", seed: "trip-hop", group: "Electronic" },
  { label: "Downtempo", seed: "downtempo", group: "Electronic" },
  { label: "Vaporwave", seed: "vaporwave", group: "Electronic" },
  { label: "Minimal Techno", seed: "minimal techno", group: "Electronic" },
  { label: "Acid House", seed: "acid house", group: "Electronic" },
  { label: "Big Room", seed: "big room", group: "Electronic" },
  { label: "Chillwave", seed: "chillwave", group: "Electronic" },
  { label: "Eurodance", seed: "eurodance", group: "Electronic" },
  { label: "Nu Disco", seed: "nu disco", group: "Electronic" },
  { label: "Jungle", seed: "jungle", group: "Electronic" },
  { label: "Future House", seed: "future house", group: "Electronic" },
  { label: "Melodic House", seed: "melodic house", group: "Electronic" },
  // Lo-fi
  ...
  { label: "Cool Jazz", seed: "cool jazz", group: "Jazz" },
  { label: "Hard Bop", seed: "hard bop", group: "Jazz" },
  { label: "Free Jazz", seed: "free jazz", group: "Jazz" },
  { label: "Latin Jazz", seed: "latin jazz", group: "Jazz" },
  { label: "Acid Jazz", seed: "acid jazz", group: "Jazz" },
  { label: "Modal Jazz", seed: "modal jazz", group: "Jazz" },
  { label: "Gypsy Jazz", seed: "gypsy jazz", group: "Jazz" },
  { label: "Dixieland", seed: "dixieland", group: "Jazz" },
  // Blues
  ...
  { label: "Country Blues", seed: "country blues", group: "Blues" },
  { label: "Texas Blues", seed: "texas blues", group: "Blues" },
  { label: "Jump Blues", seed: "jump blues", group: "Blues" },
  // Soul
  ...
  { label: "Philly Soul", seed: "philly soul", group: "Soul" },
  { label: "Psychedelic Soul", seed: "psychedelic soul", group: "Soul" },
  { label: "Blue-Eyed Soul", seed: "blue-eyed soul", group: "Soul" },
  // Funk
  { label: "P-Funk", seed: "p-funk", group: "Funk" },
  { label: "Funk Rock", seed: "funk rock", group: "Funk" },
  { label: "Boogie", seed: "boogie", group: "Funk" },
  { label: "G-Funk", seed: "g-funk", group: "Funk" },
  { label: "Jazz-Funk", seed: "jazz funk", group: "Funk" },
  { label: "Disco", seed: "disco", group: "Funk" },
  { label: "Afrobeat", seed: "afrobeat", group: "Funk" },
  // Reggae
  ...
  { label: "Lovers Rock", seed: "lovers rock", group: "Reggae" },
  { label: "Reggae Fusion", seed: "reggae fusion", group: "Reggae" },
  // Country
  ...
  { label: "Country Rock", seed: "country rock", group: "Country" },
  { label: "Bro-Country", seed: "bro-country", group: "Country" },
  { label: "Nashville Sound", seed: "nashville sound", group: "Country" },
  { label: "Bakersfield Sound", seed: "bakersfield sound", group: "Country" },
  { label: "Western Swing", seed: "western swing", group: "Country" },
  { label: "Neotraditional Country", seed: "neotraditional country", group: "Country" },
  { label: "Red Dirt", seed: "red dirt", group: "Country" },
  // Folk
  ...
  { label: "Contemporary Folk", seed: "contemporary folk", group: "Folk" },
  { label: "Freak Folk", seed: "freak folk", group: "Folk" },
  { label: "Anti-Folk", seed: "anti-folk", group: "Folk" },
  { label: "Folk Pop", seed: "folk pop", group: "Folk" },
  { label: "Chamber Folk", seed: "chamber folk", group: "Folk" },
  { label: "Appalachian", seed: "appalachian folk", group: "Folk" },
  // Latin
  ...
  { label: "Tango", seed: "tango", group: "Latin" },
  { label: "Mariachi", seed: "mariachi", group: "Latin" },
  { label: "Bolero", seed: "bolero", group: "Latin" },
  { label: "Samba", seed: "samba", group: "Latin" },
  { label: "Vallenato", seed: "vallenato", group: "Latin" },
  { label: "Banda", seed: "banda", group: "Latin" },
  // K-Pop
  ...
  { label: "Romantic", seed: "romantic era", group: "Classical" },
  { label: "Chamber Music", seed: "chamber music", group: "Classical" },
  { label: "Symphony", seed: "symphony", group: "Classical" },
  { label: "Piano", seed: "classical piano", group: "Classical" },
  { label: "Renaissance", seed: "renaissance", group: "Classical" },
  { label: "Medieval", seed: "medieval", group: "Classical" },
];
